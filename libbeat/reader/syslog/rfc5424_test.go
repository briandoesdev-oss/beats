...
func TestParseRFC5424(t *testing.T) {
	tests := map[string]struct {
		...
		"sd-with-escaped-quote": {
			in: `<165>1 2003-10-11T22:14:15.003Z mymachine.example.com evntslog - ID47 [exampleSDID@32473 key="value with \"quotes\""] This is a message`,
			want: message{
				timestamp:  mustParseTime(time.RFC3339Nano, "2003-10-11T22:14:15.003Z", nil),
				priority:   165,
				facility:   20,
				...
				msgID:      "ID47",
				msg:        "This is a message",
				rawSDValue: `[exampleSDID@32473 key="value with \"quotes\""]`,
			},
		},
		"sd-with-escape": {
